...
`examples/global_optimisation/cu4_co_alumina111_mattersim.yaml`:

```{literalinclude} ../../../../examples/global_optimisation/cu4_co_alumina111_mattersim.yaml
:language: yaml
```
...
```shell
gdp -d ./run-cu4-co-alumina111 explore \
    ./examples/global_optimisation/cu4_co_alumina111_mattersim.yaml
```
