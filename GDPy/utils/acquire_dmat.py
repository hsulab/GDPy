...
if __name__ == '__main__':
    ...
    print('O on FCC')
    atoms = read('/users/40247882/repository/GDPy/templates/structures/surf-100_opt.xyz')
    find_neighbours(atoms, xdp)


    print('O on HCP')
    atoms = read('/users/40247882/repository/GDPy/templates/structures/surf-1O-2_opt.xyz')
    type_map = {'O': 0, 'Pt': 1}
    dpinput = atoms2dpinput(type_map, [atoms])
