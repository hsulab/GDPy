...
from GDPy.graph.comparison import paragroup_unique_chem_envs
from GDPy.builder.group import create_an_intersect_group


def single_create_structure_graph(atoms: Atoms, graph_params: dict, group_commands: List[str]=None) -> List[nx.Graph]:
