...
OBSERVER_REGISTER.register("small_distance")(SmallDistanceObserver)
OBSERVER_REGISTER.register("isolated_atom")(IsolatedAtomObserver)
OBSERVER_REGISTER.register("molecule_number")(MoleculeNumberObserver)
OBSERVER_REGISTER.register("volume")(VolumeObserver)
...
def create_an_observer(params: dict) -> "Observer":
    ...
    observer = OBSERVER_REGISTER[method](**params)
