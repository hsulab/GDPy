...
class BeannManager(BasePotentialManager):
    ...
    def _make_train_files(self, dataset=None, train_dir=pathlib.Path.cwd()):
        ...
        from gdpx.execution.utils import get_composition_from_atoms
    ...
    def train(self, dataset=None, train_dir=pathlib.Path.cwd()):
        """"""
    ...
    def freeze(self, train_dir=pathlib.Path.cwd()):
        ...
        est_params = dict(committee=dict(models=models))
